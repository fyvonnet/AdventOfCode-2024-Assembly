all: day01 day01-binsearch day02 day03 day04 day05 day06 day07 day08-part1 day08-part2 day09 day10 day11 day12 \
	day13 day14 day15-part1 day15-part2 day16 day17-part1 day17-part2 day18 day19 day20 day22-part1 day22-part2 \
	day23 day24 day25
...
day17-part1: day17-part1.o misc.o stdio.o
	ld -g -o day17-part1 day17-part1.o misc.o stdio.o

day17-part2: day17-part2.o misc.o stdio.o queue.o
	ld -g -o day17-part2 day17-part2.o misc.o stdio.o queue.o
...
day20: day20.o misc.o stdio.o
	ld -g -o day20 day20.o misc.o stdio.o

day22-part1: day22-part1.o misc.o stdio.o
	ld -g -o day22-part1 day22-part1.o misc.o stdio.o

day22-part2: day22-part2.o misc.o stdio.o
	ld -g -o day22-part2 day22-part2.o misc.o stdio.o

day23: day23.o quicksort.o misc.o stdio.o memory.o redblacktree.o
	ld -g -o day23 day23.o quicksort.o misc.o stdio.o memory.o redblacktree.o

day24: day24.o misc.o stdio.o memory.o redblacktree.o quicksort.o binsearch.o
	ld -g -o day24 day24.o misc.o stdio.o memory.o redblacktree.o quicksort.o binsearch.o

day25: day25.o misc.o stdio.o
	ld -g -o day25 day25.o misc.o stdio.o
